...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameEvents = __webpack_require__(30);
	var myWordsEvents = __webpack_require__(36);
	var showDescriptionTemplate = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var myWords = __webpack_require__(36);
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  if (data.credentials.password === data.credentials.password_confirmation) {
	    api.signUp(data).then(ui.signUpSuccess).then(api.signIn(data).then(ui.signInSuccess).then(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(7);
	var showDescriptionTemplate = __webpack_require__(9);
	var showDifficultyTemplate = __webpack_require__(29);

	// Hides and clears the login/sign up modals after a certain period of time
	// Called from below functions
	var hideAndClearModal = function hideAndClearModal(modal) {
	  setTimeout(function () {
	    $(modal).modal('hide');
	  }, 1000);
	...
	var toggleHideShow = function toggleHideShow(selectors) {
	...
	module.exports = {
	  hideAndClearModal: hideAndClearModal,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"panel-group\" id=\"accordion\" role=\"tablist\" aria-multiselectable=\"true\">\n  <div class=\"panel panel-default\">\n    <div class=\"panel-heading\" role=\"tab\" id=\"headingOne\">\n      <h4 class=\"panel-title\">\n        <a role=\"button\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapseOne\" aria-expanded=\"true\" aria-controls=\"collapseOne\">\n          <h4> Game Description </h4>\n        </a>\n      </h4>\n    </div>\n    <div id=\"collapseOne\" class=\"panel-collapse collapse in\" role=\"tabpanel\" aria-labelledby=\"headingOne\">\n      <div class=\"panel-body\">\n        <p>\n        <small> This is a word scramble game!  You'll be given the option to choose\n          between three difficulty tiers: </small>\n        </p>\n        <ul>\n          <li class=\"description-list\"> <span class=\"bold\"> Easy: </span> <small> < 5 Letters </small> </li>\n          <li class=\"description-list\"> <span class=\"bold\"> Medium: </span> <small> 5 - 8 Letters </small> </li>\n          <li class=\"description-list\"> <span class=\"bold\"> Hard: </span> <small> > 8 Letters </small> </li>\n        </ul>\n        <p> <small> You'll have three tries to guess the word! </small> </p>\n      </div>\n    </div>\n  </div>\n  <div class=\"panel panel-default\">\n    <div class=\"panel-heading\" role=\"tab\" id=\"headingTwo\">\n      <h4 class=\"panel-title\">\n        <a class=\"collapsed\" role=\"button\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapseTwo\" aria-expanded=\"false\" aria-controls=\"collapseTwo\">\n          <h4> Get Started </h4>\n        </a>\n      </h4>\n    </div>\n    <div id=\"collapseTwo\" class=\"panel-collapse collapse\" role=\"tabpanel\" aria-labelledby=\"headingTwo\">\n      <div class=\"panel-body\">\n        <p> <small> Please sign up for a new account or login with an existing account to begin! </small> </p>\n      </div>\n    </div>\n  </div>\n  <div class=\"panel panel-default\">\n    <div class=\"panel-heading\" role=\"tab\" id=\"headingThree\">\n      <h4 class=\"panel-title\">\n        <a class=\"collapsed\" role=\"button\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapseThree\" aria-expanded=\"false\" aria-controls=\"collapseThree\">\n          <h4> Create Your Own Words </h4>\n        </a>\n      </h4>\n    </div>\n    <div id=\"collapseThree\" class=\"panel-collapse collapse\" role=\"tabpanel\" aria-labelledby=\"headingThree\">\n      <div class=\"panel-body\">\n        <p class=\"description\"><small> You also have the ability to create and update your own words! Just click on \"My Words\" when you login. </small></p>\n      </div>\n    </div>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<p>\n  Choose a difficulty to get started!\n</p>\n<button type=\"button\" id=\"easy\" class=\"diff-button btn btn-success\"> Easy <br><span class=\"small-text\"> < 5 letters </span></button>\n<button type=\"button\" id=\"medium\" class=\"diff-button btn btn-warning\"> Medium <br><span class=\"small-text\"> 5-8 letters </span></button>\n<button type=\"button\" id=\"hard\" class=\"diff-button btn btn-danger\"> Hard <br><span class=\"small-text\"> > 8 letters </span></button>\n<p class=\"user-message\">\n</p>\n<p>\n  OR\n</p>\n<p>\n  Create/manage your own words for other people to play!\n</p>\n<button type=\"button\" class=\"my-words-diff-button btn btn-info\"> My Words </button>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createCompletedWordData = function createCompletedWordData() {
	  return { completed_word: { word_id: store.word.id } };
	};

	// allows the user to choose a new difficulty when they're playing the game
	var onChooseNewDifficulty = function onChooseNewDifficulty(event) {
	  event.preventDefault();
	...
	var onMakeGuess = function onMakeGuess(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  if (ui.guessMade(data.guess) === true) {
	    var _data = createCompletedWordData();
	    api.createCompletedWord(_data).then(ui.createCompletedWordSuccess).catch(ui.failure);
	  }
	...
	var onNextWord = function onNextWord(event) {
	  event.preventDefault();
	  $('#hide-my-words').hide();
	  api.getWord().then(ui.getWordSuccess).then(function () {
	    $('.guess-form').on('submit', onMakeGuess);
	  }).catch(ui.failure);
	};

	// get a word of the difficulty tier that the user chooses
	var onChooseDifficulty = function onChooseDifficulty(event) {
	  event.preventDefault();
	...
	var onResetGame = function onResetGame(event) {
	  event.preventDefault();
	  api.deleteCompletedWords().then(ui.deleteCompletedWordsSuccess).catch(ui.failure);
	};
	...
	module.exports = {
	  addHandlers: addHandlers,
	  onChooseDifficulty: onChooseDifficulty
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createCompletedWord = function createCompletedWord(data) {
	  return $.ajax({
	...
	var deleteCompletedWords = function deleteCompletedWords() {
	  return $.ajax({
	...
	module.exports = {
	  getWord: getWord,
	  createCompletedWord: createCompletedWord,
	  deleteCompletedWords: deleteCompletedWords
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(7);
	var showGameTemplate = __webpack_require__(33);
	var showWinTemplate = __webpack_require__(34);
	var showLoseTemplate = __webpack_require__(35);
	var showDifficultyTemplate = __webpack_require__(29);
	...
	// check turn count
	var checkTurnCount = function checkTurnCount() {
	...
	var checkMatch = function checkMatch(guess) {
	...
	var guessMade = function guessMade(guess) {
	...
	var scrambleWord = function scrambleWord(word) {
	  ...
	  for (var i = 0; i < wordArr.length; i++) {
	    ...
	    var j = Math.floor(Math.random() * wordArr.length);
	...
	// tier already
	var getWordSuccess = function getWordSuccess(data) {
	  store.turnCount = 3;
	  if (data.word.id === '') {
	...
	// difficulty
	var chooseNewDifficulty = function chooseNewDifficulty() {
	  $('#content').html(showDifficultyTemplate());
	};
	...
	var createCompletedWordSuccess = function createCompletedWordSuccess() {
	  // console.log('successfully created a word');
	};
	// END CREATE COMPLETED WORDS FUNCTIONS

	var deleteCompletedWordsSuccess = function deleteCompletedWordsSuccess() {
	...
	module.exports = {
	  ...
	  chooseNewDifficulty: chooseNewDifficulty,
	  createCompletedWordSuccess: createCompletedWordSuccess,
	  deleteCompletedWordsSuccess: deleteCompletedWordsSuccess,
	  failure: failure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<p>\n  Guess the word correctly within <span class=\"tries\"> "
	    + alias2(alias1((depth0 != null ? depth0.turnCount : depth0), depth0))
	    + " </span> tries to complete the level!\n</p>\n<br>\n<p class=\"scrambled\">\n  "
	    + alias2(alias1((depth0 != null ? depth0.scrambled : depth0), depth0))
	    + "\n</p>\n<form class=\"guess-form\">\n  <div class=\"form-group\">\n    <div class=\"col-xs flex-xs-middle\">\n      <input type=\"text\" name=\"guess\" class=\"form-control\" id=\"user-guess\" placeholder=\"enter your guess\">\n    </div>\n  </div>\n  <button type=\"submit\" class=\"btn btn-default\" id=\"guess-button\">Guess</button>\n</form>\n<div class=\"col-xs flex-xs-middle please-note\">\n  <small>\n    <p>\n      <b> Please note: </b><br>\n      Even though you may be able to unscramble the letters into multiple words, there is only <i><b> one right answer. </b></i> <br>\n      Also, a word will not scramble to itself.\n    </p>\n  </small>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    ...
	    + "\n</p>\n<p class=\"user-message\">\n</p>\n<div class=\"play-again\">\n  <button type=\"button\" class=\"btn btn-default new-difficulty-button\">Choose New Difficulty</button>\n  <button type=\"button\" class=\"btn btn-default next-word-button\">Next Word</button>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<p>\n  Sorry, you weren't able to guess the word within 3 tries.  Better luck next time!\n</p>\n<small>\n  Placeholder note to explain how a user can try again (maybe it will automatically grab it next\n  time they choose the same difficulty setting?)\n</small>\n<div class=\"play-again\">\n  <button type=\"button\" class=\"btn btn-default new-difficulty-button\">Choose New Difficulty</button>\n  <button type=\"button\" class=\"btn btn-default next-word-button\">Next Word</button>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onFindId = function onFindId(event) {
	  event.preventDefault();
	...
	var getDifficulty = function getDifficulty(newWord) {
	  if (newWord.length < 5) {
	    return 'easy';
	...
	// the ajax call
	var onUpdateWord = function onUpdateWord(newWord) {
	  var newDifficulty = getDifficulty(newWord);
	  var data = { word: { word: newWord, difficulty: newDifficulty } };
	  api.updateWord(data).then(ui.updateWordSuccess).then(function () {
	...
	// the ajax call
	var onCreateWord = function onCreateWord(newWord) {
	  // console.log('start of create new word');
	  var newDifficulty = getDifficulty(newWord);
	  var data = { word: { word: newWord, difficulty: newDifficulty } };
	  api.createWord(data).then(ui.createWordSuccess).catch(ui.failure);
	};

	// when a user clicks to refresh words, refresh them
	var onRefreshWords = function onRefreshWords(event) {
	  event.preventDefault();
	  api.myWordsIndex().then(ui.displayMyWords).then(function () {
	    $('.update-word').on('click', onFindId);
	...
	var checkWordExistence = function checkWordExistence(newWord, type) {
	  // console.log('beginning of check word existence');
	  api.wordsIndex().then(ui.wordsIndexSuccess).then(function () {
	    if (store.allWords.some(function (elem) {
	      return elem === newWord;
	    })) {
	...
	var onSubmitUpdate = function onSubmitUpdate(event) {
	  event.preventDefault();
	  var newWord = getFormFields(this).word;
	  var type = 'update';
	...
	// it hasn't been created already
	var onSubmitCreate = function onSubmitCreate(event) {
	  event.preventDefault();
	  var newWord = getFormFields(this).word;
	  var type = 'create';
	  checkWordExistence(newWord, type);
	...
	// words owned by them
	var onClickMyWords = function onClickMyWords(event) {
	  event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var myWordsIndex = function myWordsIndex() {
	  return $.ajax({
	...
	var wordsIndex = function wordsIndex() {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showMyWordsTemplate = __webpack_require__(39);
	var store = __webpack_require__(7);
	...
	var displayMyWords = function displayMyWords(data) {
	...
	// it in array
	var wordsIndexSuccess = function wordsIndexSuccess(data) {
	  store.allWords = [];
	...
	// list of users words
	var updateWordSuccess = function updateWordSuccess(data) {
	  $('.modal-success').html('Success');
	...
	// list of users words
	var createWordSuccess = function createWordSuccess() {
	  $('.modal-success').html('Success');
	...
	module.exports = {
	  displayMyWords: displayMyWords,
	  wordsIndexSuccess: wordsIndexSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "      <tr>\n        <!-- <td> "
	    ...
	    + " </td> -->\n        <td> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.word : stack1), depth0))
	    + " </td>\n        <td> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.difficulty : stack1), depth0))
	    + " </td>\n        <!-- <td> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.owner_id : stack1), depth0))
	    + " </td> -->\n        <td>\n          <button type=\"button\" class=\"btn-sm btn-defaults update-word\" data-toggle=\"modal\" data-target=\"#update-word-modal\" data-word-id= "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + ">\n            Edit\n          </button>\n      </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<h2> Create/Manage Your Words </h2>\n<p class=\"description\"><small>\n  Below is a list of all the words you've created so far.  You can click \"Create Word\" to create\n  a new one or click Edit next to the word you'd like to update.  Please note, you can't delete\n  the words you've created as they may already have been played by others.\n</small></p>\n<button type=\"button\" class=\"btn-lg btn-default create-word-button\" data-toggle=\"modal\" data-target=\"#create-word-modal\">\n  Create New Word\n</button>\n<button type=\"button\" class=\"btn-lg btn-default refresh-words-button\">\n  Refresh\n</button>\n\n<div class=\"display-my-words\">\n  <table class=\"my-words-table\">\n      <tr>\n        <!-- <th> ID </th> -->\n        <th> Word </th>\n        <th> Difficulty </th>\n        <!-- <th> Owner </th> -->\n        <th> Manage </th>\n      </tr>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.words : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </table>\n    <!-- data-word-id="
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.easy_word : depth0)) != null ? stack1.id : stack1), depth0))
	    + " -->\n</div>\n";
